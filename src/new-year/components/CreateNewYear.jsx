...
import { Calendar, User, MessageSquare, Upload, Image as ImageIcon, Music, Play, Pause, X, Plus, Sparkles } from 'lucide-react';
...
const CreateNewYear = () => {
    ...
    const messageSuggestions = [
        "Happy New Year! May this year bring you endless joy, success, and new adventures!",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = customSlug
                ? `${window.location.origin}/new-year/${customSlug}`
                : `${window.location.origin}/new-year/${docRef.id}`;
            setCardUrl(url);
            ...
            console.error("Error creating new year card:", error);
            ...
            <div className="form-page-container">
                ...
                <div className="glass-form-card">
                    <div className="glass-form-header">
                        <h1 className="glass-form-title">New Year Card</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="glass-form">
                        ...
                        <div className="glass-form-section">
                            <h3 className="glass-section-title">
                                <MessageSquare size={20} /> New Year Message
                            </h3>
                            ...
                            <div className="glass-form-group">
                                <textarea
                                    ...
                                    rows="5"
                                    placeholder="Write your New Year message..."
                        ...
                        <div className="glass-form-section">
                            <h3 className="glass-section-title">
                                <Music size={20} /> Add a Celebration Song (Optional)
                            </h3>
                            {!selectedSong ? (
                                <button
                                    type="button"
