...
import { Plane, Map, Compass, User, MessageSquare, Upload, Image as ImageIcon, Music, Play, Pause, X, Plus } from 'lucide-react';
...
const CreateBonVoyage = () => {
    ...
    const messageSuggestions = [
        "Bon Voyage! Have an amazing trip and stay safe.",
        "Wishing you a safe journey and lots of wonderful memories.",
        "Adventure awaits! Enjoy every moment of your trip.",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const cardId = uuidv4();
            const cardDoc = doc(db, 'bon_voyage_cards', cardId);
            ...
            const url = customSlug
                ? `${window.location.origin}/bon-voyage/${customSlug}`
                : `${window.location.origin}/bon-voyage/${cardId}`;
            setCardUrl(url);
    ...
    return (
        <>
            <div className="form-page-container">
                ...
                <div className="form-page-background" style={{ background: 'linear-gradient(135deg, #a18cd1 0%, #fbc2eb 100%)' }} />

                <div className="glass-form-card">
                    <div className="glass-form-header">
                        <h1 className="glass-form-title">Bon Voyage</h1>
                        <p className="glass-form-subtitle">Wish them a safe journey</p>
                    </div>

                    <form onSubmit={handleSubmit} className="glass-form">
                        <div className="glass-form-section">
                            <h3 className="glass-section-title">
                                <Plane size={20} /> Traveler Details
                            </h3>
                            <div className="glass-form-group">
                                <label className="glass-form-label">Traveler's Name</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div className="glass-form-group">
                                <label className="glass-form-label">Destination</label>
                                <input
                                    type="text"
                                    required
                                    className="glass-form-input"
...
export default CreateBonVoyage;
