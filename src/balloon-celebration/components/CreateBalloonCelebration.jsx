...
import { Balloon, User, MessageSquare, Upload, Image as ImageIcon, Music, Play, Pause, X, Plus } from 'lucide-react';
...
const CreateBalloonCelebration = () => {
    ...
    const {
        ...
        clearDraft,
        markClean
    } = useFormDraft('draft:balloon-celebration', {
        recipientName: '',
        sender: '',
        message: '',
        celebrationReason: '',
    ...
    const messageSuggestions = [
        "Let's celebrate! You deserve all the joy and happiness in the world!",
        "Time to pop the champagne and celebrate this amazing moment!",
        "Raising a toast to you! May your celebration be filled with laughter and love!",
        "Celebrating you today! You make the world brighter just by being in it!"
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = customSlug
                ? `${window.location.origin}/balloon-celebration/${customSlug}`
                : `${window.location.origin}/balloon-celebration/${docRef.id}`;
            setCardUrl(url);
            ...
            console.error("Error creating balloon celebration card:", error);
            ...
            <div className="form-page-container">
                ...
                <div className="glass-form-card">
                    <div className="glass-form-header">
                        <h1 className="glass-form-title">Balloon Celebration Card</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="glass-form">
                        ...
                        <div className="glass-form-section">
                            <h3 className="glass-section-title">
                                <MessageSquare size={20} /> Celebration Message
                            </h3>
                        ...
                        <div className="glass-form-section">
                            <h3 className="glass-section-title">
                                <Balloon size={20} /> Celebration Reason (Optional)
                            </h3>
                            <div className="glass-form-group">
                                <textarea
                                    className="glass-form-textarea"
                                    rows="3"
                                    placeholder="What are we celebrating? (achievement, milestone, special occasion...)"
                                    value={formData.celebrationReason}
                                    onChange={(e) => setFormData({ ...formData, celebrationReason: e.target.value })}
                                />
                            </div>
                        </div>
...
export default CreateBalloonCelebration;
