...
import { Award, User, MessageSquare, Upload, Image as ImageIcon, Music, Play, Pause, X, Plus } from 'lucide-react';
...
const CreateRetirement = () => {
    ...
    const messageSuggestions = [
        "Congratulations on your retirement! You've earned every moment of this new chapter!",
        "Happy Retirement! May your days be filled with joy, relaxation, and new adventures!",
        "Cheers to your retirement! Thank you for your dedication and hard work over the years.",
        "Retirement looks good on you! Wishing you all the happiness and relaxation you deserve!"
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = customSlug
                ? `${window.location.origin}/retirement/${customSlug}`
                : `${window.location.origin}/retirement/${docRef.id}`;
            setCardUrl(url);
            ...
            console.error("Error creating retirement card:", error);
            ...
            <div className="form-page-container">
                ...
                <div className="glass-form-card">
                    <div className="glass-form-header">
                        <h1 className="glass-form-title">Retirement Card</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="glass-form">
                        ...
                        <div className="glass-form-section">
                            <h3 className="glass-section-title">
                                <MessageSquare size={20} /> Retirement Message
                            </h3>
                            ...
                            <div className="glass-form-group">
                                <textarea
                                    ...
                                    rows="5"
                                    placeholder="Write your retirement message..."
