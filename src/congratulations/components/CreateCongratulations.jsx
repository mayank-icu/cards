...
import { PartyPopper, User, Trophy, MessageSquare, Upload, Image as ImageIcon, Music, Play, Pause, X, Plus } from 'lucide-react';
...
import congratulationsBg from '../../assets/backgrounds/congratulations.webp';

const CreateCongratulations = () => {
    ...
    const {
        ...
        clearDraft,
        markClean
    } = useFormDraft('draft:congratulations', {
        recipient: '',
        sender: '',
        message: '',
        achievement: '',
    ...
    const messageSuggestions = [
        "Congratulations on your amazing achievement! You've worked so hard for this moment.",
        "So proud of you! This is just the beginning of great things to come.",
        "Your dedication and hard work have paid off. Congratulations!",
        "Well deserved! Wishing you continued success in all your future endeavors."
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const congratulationsId = uuidv4();
            const congratulationsDoc = doc(db, 'congratulations', congratulationsId);
            await setDoc(congratulationsDoc, {
                ...formData,
                song: selectedSong,
                createdAt: Date.now()
            });
            ...
            if (customSlug) {
                ...
                await setDoc(slugDoc, {
                    ...
                    cardId: congratulationsId,
                    createdAt: Date.now()
                });
            }

            const url = customSlug
                ? `${window.location.origin}/congratulations/${customSlug}`
                : `${window.location.origin}/congratulations/${congratulationsId}`;
            setCardUrl(url);
            ...
            console.error("Error creating congratulations card:", error);
            ...
            <div className="form-page-container">
                ...
                <div className="glass-form-card">
                    <div className="glass-form-header">
                        <h1 className="glass-form-title">Congratulations Card</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="glass-form">
                        ...
                        <div className="glass-form-section">
                            ...
                            <div className="glass-form-group">
                                <textarea
                                    ...
                                    rows="5"
                                    placeholder="Write your congratulatory message or choose a suggestion above..."
                        ...
                        <div className="glass-form-section">
                            ...
                            <div className="glass-form-group">
                                <label className="glass-form-label">What are you congratulating them for?</label>
                                <input
                                    type="text"
                                    required
                                    className="glass-form-input"
                                    placeholder="e.g., Graduation, Promotion, Achievement"
...
export default CreateCongratulations;
