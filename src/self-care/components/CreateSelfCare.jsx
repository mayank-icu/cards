...
import { Coffee, Moon, Sun, User, MessageSquare, Upload, Image as ImageIcon, Music, Play, Pause, X, Plus, Sparkles } from 'lucide-react';
...
const CreateSelfCare = () => {
    ...
    const messageSuggestions = [
        ...
        "Just a gentle reminder to breathe, relax, and recharge.",
        "You can't pour from an empty cup. Take care of yourself first.",
        "Sending you some calm and positive vibes. Relax and enjoy."
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const cardId = uuidv4();
            const cardDoc = doc(db, 'self_care_cards', cardId);
            ...
            const url = customSlug
                ? `${window.location.origin}/self-care/${customSlug}`
                : `${window.location.origin}/self-care/${cardId}`;
            setCardUrl(url);
    ...
    return (
        <>
            <div className="form-page-container">
                <div className="form-page-background" style={{ background: 'linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)' }} />

                <div className="glass-form-card">
                    <div className="glass-form-header">
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', justifyContent: 'center' }}>
                            <Sparkles size={32} color="#8ec5fc" />
                            <h1 className="glass-form-title">Self-Care Reminder</h1>
                        </div>
                        <p className="glass-form-subtitle">Send a gentle reminder</p>
                    </div>
