...
const CreateApology = () => {
    ...
    const messageSuggestions = [
        "I'm truly sorry for my actions. I hope you can forgive me and give me a chance to make things right.",
        "I made a mistake and I deeply regret it. Your friendship means the world to me. Please forgive me.",
        "I'm sorry for hurting you. I value our relationship and want to work through this together.",
        "Please accept my sincere apology. I promise to do better and learn from this mistake."
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const apologyId = uuidv4();
            const apologyDoc = doc(db, 'apologies', apologyId);
            await setDoc(apologyDoc, {
                ...formData,
                song: selectedSong,
                createdAt: Date.now()
            });
            ...
            const url = customSlug
                ? `${window.location.origin}/apology/${customSlug}`
                : `${window.location.origin}/apology/${apologyId}`;
            setCardUrl(url);
            ...
            console.error("Error creating apology card:", error);
            ...
            <div className="form-page-container">
                ...
                <div className="glass-form-card">
                    <div className="glass-form-header">
                        <h1 className="glass-form-title">Apology Card</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="glass-form">
                        ...
                        <div className="glass-form-section">
                            ...
                            <div className="glass-form-group">
                                <textarea
                                    ...
                                    rows="5"
                                    placeholder="Write your sincere apology or choose a suggestion above..."
                        ...
                        <div className="glass-form-section">
                            <SlugInput value={customSlug} onChange={setCustomSlug} cardType="apology" />
                        </div>
